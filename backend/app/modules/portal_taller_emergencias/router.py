...
from app.modules.portal_taller.router import require_taller_responsable
...
router = APIRouter(prefix="/portal/taller/emergencias", tags=["Emergencias (portal taller)"])
