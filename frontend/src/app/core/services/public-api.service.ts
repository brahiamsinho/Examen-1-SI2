...
export interface PublicPricingBootstrapDto {
  plans: PricingPlanDto[];
  stripe: StripePublicConfigDto;
}
...
export class PublicApiService {
  ...
  getPricingBootstrap(): Observable<PublicPricingBootstrapDto> {
    return this.http.get<PublicPricingBootstrapDto>(`${this.base}/pricing/bootstrap`);
  }
